...
class LMOClockController(
    ...
    override val config: ClockConfig by lazy {
        ClockConfig(
            LMO_CLOCK_ID,
            resources.getString(R.string.lmo_clock_default_name),
            resources.getString(R.string.lmo_clock_default_description)
        )
    }

    init {
        val parent = FrameLayout(ctx)
        val small = AnimatableClockView(ctx).apply {
        ...
        val large = AnimatableClockView(ctx).apply {
