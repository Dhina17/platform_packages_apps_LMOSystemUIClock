package com.android.systemui.plugin.lmoclock;
...
public class SampleOverlayPlugin implements ClockProviderPlugin {
    private static final String TAG = "ClockProviderPlugin";
